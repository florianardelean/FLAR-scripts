-- @description - Renames untitled tracks according to the name of the first media item on each track.
...
-- @description - Tracks that currently have a name will be ignored.
...
reaper.Undo_EndBlock("FLAR scripts_Name untitled tracks from first Media Item", -1)
